...
* [IOPS](http://en.wikipedia.org/wiki/IOPS): **602.2** <sup>[[1]](#cpu_bound)</sup>
* sequential read: **1329MB/s** <sup>[[1]](#cpu_bound)</sup>
* sequential write: **795MB/s** <sup>[[1]](#cpu_bound)</sup>
* double-parity RAID: **RAID-Z2**

***[2014-10-29 We have updated the performance numbers. The old numbers were wrong (they were too low). Specifically, the old performance numbers were generated by a benchmark which was CPU-bound, not DISK-bound. We re-generated the numbers by running 8 benchmarks in parallel and summing the throughput in order to eliminate the CPU bottleneck (the processor on which the jobs were running has 8 cores)]***
